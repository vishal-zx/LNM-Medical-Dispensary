# Generated by Django 3.2.9 on 2021-12-22 15:26
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isApproved', models.BooleanField(
                    default=True, verbose_name='IsApproved')),
            ],
        ),
        migrations.CreateModel(
            name='Chemist',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Aid', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='users.appointment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medicine', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.medicine')),
                ('patient', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.patient')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.doctor')),
                ('patient', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.patient')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_doctor', models.BooleanField(
                    default=False, verbose_name='Is doctor')),
                ('patient', models.BooleanField(
                    default=False, verbose_name='Is patient')),
                ('is_chemist', models.BooleanField(
                    default=False, verbose_name='Is chemist')),
